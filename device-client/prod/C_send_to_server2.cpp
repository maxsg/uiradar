...
{   
    ...
    srand(time(NULL));
        ...
        for(unsigned int j = 0; j < batch_size; j++) {  
            ...
            // temp_chunk.traj[x] = RandomFloat(xmin, xmax);
            // temp_chunk.traj[y] = RandomFloat(ymin, ymax);
            // temp_chunk.traj[z] = RandomFloat(zmin, zmax);

            // temp_chunk.traj[x] = gen_random_float(xmin, xmax);
            // temp_chunk.traj[y] = gen_random_float(ymin, ymax);
            // temp_chunk.traj[z] = gen_random_float(zmin, zmax);
